    ...
    <main class="activities-page">
        <div class="subpage-firstview">
            <div class="page-label">
                <div class="container">
                    <h2 class="eng font-20-800">Activities</h2>
                    <h1 class="head-text font-40-700">活動内容</h1>
        ...
        <div class="group-members">
            <div class="container">
                <h2 class="title font-24-700">ワーキンググループメンバー</h2>
                <div class="table-wrapper">
                    <div class="row-wrapper">
                        <p class="head font-18-700">産業</p>
                        <p class="content font-18-500">中小企業経営者および社員</p>
                    </div>
                    <div class="row-wrapper">
                        <p class="head font-18-700">大学</p>
                        <p class="content font-18-500">東京大学</p>
                    </div>
                    <div class="row-wrapper">
                        <p class="head font-18-700">行政</p>
                    ...
                    <div class="row-wrapper">
                        <p class="head font-18-700">金融</p>
                        <p class="content font-18-500">みずほ銀行</p>
                    </div>
                    <div class="row-wrapper">
                        <p class="head font-18-700">専門家</p>
                        <p class="content font-18-500">社労士／会計士産業保健</p>
                    </div>
                </div>
                <a class="href-left" href="<?php echo HOME . 'members'; ?>">
                    ...
                    <span class="font-18-700">健康投資推進協議会メンバー</span>
                </a>
            </div>
        </div>

        <div class="realizing-issues">
            <div class="container">
                <div class="title font-24-700">
                    健康を中心に考える持続可能な社会の実現
                </div>
                <p class="desc font-18-500">
                    社会課題である健康寿命を延ばすために、企業が従業員の健康を中心に考え、健康投資をあらゆるパートナーと実現することは、社会課題の解決だけでなく、従業員の自己実現や幸福度の向上につながり、職場にとっては、従業員の労働に対する主体性の向上によって業績の向上へとつながります。<br>
                    企業が従業員の健康に投資することは社会課題の解決と企業価値の向上、従業員の自己実現につながります。
                </p>
                <a class="href-left" href="<?php echo HOME . 'apply'; ?>">
                    <div class="svg-wrapper">
                        <div class="circle"></div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                            fill="none">
                    ...
                    <span class="font-18-700">健康投資推進協議会への参加について</span>
                </a>
                <img class="graphic-society" src="<?php echo T_DIRE_URL; ?>/assets/img/graphic_society.png">
            </div>
        </div>
    </main>
