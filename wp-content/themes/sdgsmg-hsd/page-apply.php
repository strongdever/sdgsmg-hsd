...
?>
    ...
    <main class="apply-page">
        <div class="subpage-firstview">
            <div class="page-label">
                <div class="container">
                    ...
                    <h1 class="head-text font-40-700">参加案内</h1>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <a class="href-left" href="<?php echo HOME . 'inquery'; ?>">
                ...
                <span class="font-18-700">お問い合わせはこちら</span>
            </a>

            <div class="section1">
                <div class="green-title font-24-700">
                    参加企業におけるメリット
                </div>
                <div class="spot-title with-desc font-18-700">健康投資推進協議会ワーキンググループ（HSD研究会）月1回の開催へのご参加</div>
                <div class="sub-desc font-16-500">
                    ・ 経営者および担当者が、社会的視座を学ぶことができます。<br>
                    ・ 経営者および担当者が、健康投資やHSDの概念に関する学びを得られます。
                </div>
                <div class="spot-title font-18-700">自社健康投資における事例について有識者の助言をもらいながら、資料作成・発表が出来るようになる</div>
                <div class="spot-title font-18-700">他社事例について学び、自社の取組みに反映できる</div>
                <div class="spot-title font-18-700">健康投資シンポジウムにて、自社事例を発表できる（選抜方式）</div>
                <div class="spot-title doing-ready font-18-700">自社HPにHSDバナーを掲載できる</div>
                <div class="spot-title doing-ready last-one font-18-700">SDGsプラットフォームHP内の健康投資推進協議会ページでの自社バナー掲載</div>

                <div class="green-title font-24-700">
                    賛助企業におけるメリット
                </div>
                <div class="spot-title font-18-700">健康投資推進協議会 ワーキンググループ（HSD研究会）月1回の開催へのオブザーブ参加</div>
                <div class="spot-title font-18-700">健康投資シンポジウムでのオンラインおよび現地における広告記載</div>
                <div class="spot-title font-18-700">健康投資推進協議会内における協議会メンバーとの連携・相談</div>
            </div>
        </div>
    </main>
