...
?>
    ...
    <main class="issues-page">
        <div class="subpage-firstview">
            <div class="page-label">
                <div class="container">
                    ...
                    <h1 class="head-text font-40-700">社会課題</h1>
        ...
        <div class="about-population">
            <div class="container">
                <h2 class="top-title font-24-700">人口構造の変化について</h2>
                <h3 class="sub-title font-32-700">全人口に占める65歳以上の人口比率</h3>
                <div class="img-wrapper">
                    <img class="graph-1 first-ranking" src="<?php echo T_DIRE_URI; ?>/assets/img/graph_1.svg">
                </div>
                <h3 class="sub-title font-32-700">50歳以上の人口比率</h3>
                <div class="img-wrapper aged-fifty">
                    <img class="graph-2" src="<?php echo T_DIRE_URI; ?>/assets/img/graph_2.svg">
                </div>
                <p class="notice font-16-500">
                    参考 ： <span class="green-color font-16-700">健康経営の推進について 令和4年6月 経済産業省 ヘルスケア産業課</span>
                </p>
            </div>
        </div>
        ...
        <div class="society-issues">
            <div class="container">
                <div class="issues">
                    <h2 class="top-title font-24-700">国と企業が抱える社会課題</h2>
                    <ul class="country-company">
                        <li class="country">
                            <div class="label font-24-700">国</div>
                            <div class="content">
                                <p class="font-24-700">
                                    少子高齢化による若い労働力の減少<br>
                                    医療費・介護費用の増大
                        ...
                        <li class="company">
                            <div class="label font-24-700">企業</div>
                            <div class="content">
                                <p class="font-24-700">
                                    定年延長による人材の高齢化<br>
                                    傷病リスクによる労働力の減少
                ...
                <div class="coporate-efforts">
                    <h2 class="top-title font-24-700">持続可能な社会の実現に向けた企業の取り組み</h2>
                    <p class="spot-title font-28-700 underline-text">
                        健康寿命を延ばし、労働人材を確保する
                    </p>
                    <p class="spot-title font-28-700 underline-text">
                    ...
                    <div class="rect-content">
                        <h1 class="title font-40-700">持続可能な長寿社会の実現</h1>
