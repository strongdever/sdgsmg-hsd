    ...
    <div class="subpage-firstview">
        <div class="page-label">
            <div class="container">
                ...
                <h1 class="head-text font-40-700">活動報告</h1>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="left-wrapper">
                ...
                <a class="href-left" href="<?php echo HOME . 'report'; ?>">
                    ...
                    <span class="font-18-700">一覧に戻る</span>
                </a>
            </div>
            ...
            <div class="sidebar">
                ...
                <div class="categories-wrapper">
                    <div class="spot-title font-20-700">カテゴリー</div>
                    <?php
                    $cats_args = [
                ...
                <?php if ($popular_posts_query->have_posts()): ?>
                    <div class="articles-wrapper frequency">
                        <div class="spot-title font-20-700">よく読まれている記事</div>
                ...
                <div class="articles-wrapper recent">
                    <div class="spot-title font-20-700">最新記事</div>
                    <ul class="article-list">
                        <?php while ($popular_posts_query->have_posts()):
                            $popular_posts_query->the_post(); ?>
                            <li>
