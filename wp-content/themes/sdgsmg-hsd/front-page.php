    ...
    <section class="mainview">
        <div class="container">
            <div class="left-wrapper">
                <h1 class="desc font-42-700">
                    <span class="font-36-700">これからの長寿社会に向けて<br></span>
                    企業における健康投資を推進する
                </h1>
                <a class="btn btn-green" href="<?php echo HOME . 'activities'; ?>">
        ...
        <section class="news">
            <div class="container">
                <div class="head-wrapper">
                    ...
                    <h1 class="head-text font-24-700">お知らせ</h1>
                </div>
                <ul class="news-list">
                ...
                <a class="href-right" href="<?php echo HOME . 'news'; ?>">
                    <span class="font-18-700">お知らせ一覧</span>
        ...
        <div class="container">
            ...
            <div class="right-wrapper">
                ...
                <a class="href-right" href="<?php echo HOME . 'issues'; ?>">
                    <span class="font-18-700">社会課題について</span>
                    <div class="svg-wrapper">
                        <div class="circle"></div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path
        ...
        <div class="container">
            <div class="left-wrapper">
                ...
                <a class="href-right" href="<?php echo HOME . 'activities'; ?>">
                    <span class="font-18-700">活動内容について</span>
                    <div class="svg-wrapper">
                        <div class="circle"></div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path
        ...
        <section class="report">
            <div class="container">
                <div class="head-wrapper">
                    ...
                    <h1 class="head-text font-24-700">活動報告</h1>
                </div>
    ...
    <section class="seminar">
        <div class="container">
            <div class="head-wrapper">
                ...
                <h1 class="head-text font-24-700">動画セミナー</h1>
            </div>
